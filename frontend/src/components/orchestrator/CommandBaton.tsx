...
export function CommandBaton({
  ...
  return (
    <form
      ...
      className={[
        "orch-baton absolute bottom-12 left-1/2 z-10 flex h-12 w-[480px] max-w-[calc(100vw-2rem)] -translate-x-1/2 items-center rounded-full border border-[color:var(--border)] bg-[color:var(--surface)] px-6 shadow-[0_10px_30px_rgba(0,0,0,0.5)] transition-all duration-[600ms]",
        listening ? "listening" : "",
