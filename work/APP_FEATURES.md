...
- **Cloud vision (locked 2026-09-22):** default **deny** per customer to protect NDA drawings. For customers the owner has authorised, cloud analysis is capped at **5 drawings per cycle running 10:00 → 10:00**, counting automated mail ingests and the owner's own uploads in one pool. A sixth drawing pauses and asks for an explicit override, which grants one document only. Known drawings answer from the saved card for free.
